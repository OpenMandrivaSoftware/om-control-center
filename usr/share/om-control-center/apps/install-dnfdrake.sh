...
if rpm -q dnfdrake &>/dev/null; then
	...
	pkexec dnf install -y dnf-utils python-dnf-plugin-versionlock createrepo_c lsb-release
	enable-repo unsupported
	pkexec dnf download gambas3-gb-dbus gambas3-gb-form gambas3-gb-gtk3 gambas3-gb-gui gambas3-gb-image gambas3-gb-qt5 gambas3-runtime gambas3-gb-form-stock dnfdrake
	#
	rpm -ivh --nodeps *.rpm
	if rpm -q dnfdrake &>/dev/null; then
